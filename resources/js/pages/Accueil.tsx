                ...
                <main className="mx-auto w-full max-w-[1580px] px-4 pb-6 pt-4 sm:px-6 sm:pt-6 lg:px-8 lg:pb-8">
                    <section className="relative overflow-hidden bg-[#f5f4f1]">
                        <div
                            ...
                            style={{
                                backgroundImage: "url('/media/banniere')",
                        ...
                        <motion.div
                            ...
                            className="pointer-events-none absolute right-2 bottom-10 hidden w-44 xl:right-12 xl:block xl:w-52"
                        >
                            <div className="rounded-lg border-4 border-white bg-white p-2 shadow-[0_25px_60px_rgba(18,59,104,0.28)]">
                                <img
                                    src="/media/convention"
                                    alt="Convention JFCI"
                                    className="aspect-[4/5] w-full rounded-sm object-cover"
                                />
                                <p className="mt-2 pb-1 text-center text-[10px] font-semibold tracking-wide text-slate-500">
                                    JFCI 
                                </p>
                            </div>
                        </motion.div>
